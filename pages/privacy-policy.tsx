    ...
    <div dir="ltr" className="m-8">
      ...
      <ul>
        ...
        <li>
          ...
          this Agreement) refers to 188.166.172.184.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to 188.166.172.184, accessible from
          http://188.166.172.184/
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <strong>To provide You</strong> including to monitor the usage of our
          Service.
        </li>
        <li>
          <strong>To provide and maintain our Service</strong> with news,
        ...
        <li>
          <strong>TFor business transfers:</strong>We may share or transfer Your
      ...
      <ul>
        <li>By email: emadunan@gmail.com</li>
      </ul>
    </div>
  );
};
